...
export const BANK: readonly Pattern[] = [
  ...
  // Extended-chord shells: reduced 4-note voicings (root-position).
  { name: 'dom9-shell', display: 'Dominant 9th', kind: 'chord', intervals: [R, M3, m7, M2], tier: 'expert', qualifier: 'shell' },
  { name: 'dom13-shell', display: 'Dominant 13th', kind: 'chord', intervals: [R, M3, m7, M6], tier: 'expert', qualifier: 'shell' },
  ...
  { name: 'maj-inv1', display: 'Major', kind: 'triad', intervals: [M3, P5, R], tier: 'expert', qualifier: '1st inversion' },
  { name: 'maj-inv2', display: 'Major', kind: 'triad', intervals: [P5, R, M3], tier: 'expert', qualifier: '2nd inversion' },
  { name: 'min-inv1', display: 'Minor', kind: 'triad', intervals: [m3, P5, R], tier: 'expert', qualifier: '1st inversion' },
  { name: 'min-inv2', display: 'Minor', kind: 'triad', intervals: [P5, R, m3], tier: 'expert', qualifier: '2nd inversion' },
  { name: 'dim-inv1', display: 'Diminished', kind: 'triad', intervals: [m3, dim5, R], tier: 'expert', qualifier: '1st inversion' },
  { name: 'dim-inv2', display: 'Diminished', kind: 'triad', intervals: [dim5, R, m3], tier: 'expert', qualifier: '2nd inversion' },
  { name: 'aug-inv1', display: 'Augmented', kind: 'triad', intervals: [M3, aug5, R], tier: 'expert', qualifier: '1st inversion' },
  { name: 'aug-inv2', display: 'Augmented', kind: 'triad', intervals: [aug5, R, M3], tier: 'expert', qualifier: '2nd inversion' },
  // Triad 5–3–R re-voicings ⟂ (fifth-bottom, root-top).
  { name: 'maj-53r', display: 'Major', kind: 'triad', intervals: [P5, M3, R], tier: 'expert', qualifier: '5–3–R' },
  { name: 'min-53r', display: 'Minor', kind: 'triad', intervals: [P5, m3, R], tier: 'expert', qualifier: '5–3–R' },
  { name: 'dim-53r', display: 'Diminished', kind: 'triad', intervals: [dim5, m3, R], tier: 'expert', qualifier: '5–3–R' },
  { name: 'aug-53r', display: 'Augmented', kind: 'triad', intervals: [aug5, M3, R], tier: 'expert', qualifier: '5–3–R' },
  // Rootless guide-tone dyads ⟂ — named by the interval they realize + which
  // guide-tone pair produces it (teaches the mapping; docs/07 M1).
  { name: 'gt-dom-37', display: 'Diminished 5th', kind: 'interval', intervals: [M3, m7], tier: 'expert', qualifier: 'dom guide tones' },
  { name: 'gt-dom-73', display: 'Augmented 4th', kind: 'interval', intervals: [m7, M3], tier: 'expert', qualifier: 'dom guide tones' },
  { name: 'gt-min-37', display: 'Perfect 5th', kind: 'interval', intervals: [m3, m7], tier: 'expert', qualifier: 'min guide tones' },
  { name: 'gt-min-73', display: 'Perfect 4th', kind: 'interval', intervals: [m7, m3], tier: 'expert', qualifier: 'min guide tones' },
  { name: 'gt-maj-37', display: 'Perfect 5th', kind: 'interval', intervals: [M3, M7], tier: 'expert', qualifier: 'maj guide tones' },
  { name: 'gt-maj-73', display: 'Perfect 4th', kind: 'interval', intervals: [M7, M3], tier: 'expert', qualifier: 'maj guide tones' },
  // Rootless 3–6 dyads ⟂.
  { name: 'd36-maj', display: 'Perfect 4th', kind: 'interval', intervals: [M3, M6], tier: 'expert', qualifier: 'maj 3–6' },
  { name: 'd36-maj-r', display: 'Perfect 5th', kind: 'interval', intervals: [M6, M3], tier: 'expert', qualifier: 'maj 3–6' },

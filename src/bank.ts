...
export const BANK: readonly Pattern[] = [
  ...
  // two-note interval dyads — every interval except R/dimR/augR/dim4
  { name: 'int-m2', intervals: [R, m2] },
  { name: 'int-M2', intervals: [R, M2] },
  { name: 'int-m3', intervals: [R, m3] },
  { name: 'int-M3', intervals: [R, M3] },
  { name: 'int-P4', intervals: [R, P4] },
  { name: 'int-aug4', intervals: [R, aug4] },
  { name: 'int-dim5', intervals: [R, dim5] },
  { name: 'int-P5', intervals: [R, P5] },
  { name: 'int-aug5', intervals: [R, aug5] },
  { name: 'int-m6', intervals: [R, m6] },
  { name: 'int-M6', intervals: [R, M6] },
  { name: 'int-m7', intervals: [R, m7] },
  { name: 'int-M7', intervals: [R, M7] },
  { name: 'int-dim7', intervals: [R, dim7] },
  { name: 'int-aug2', intervals: [R, aug2] },
];
